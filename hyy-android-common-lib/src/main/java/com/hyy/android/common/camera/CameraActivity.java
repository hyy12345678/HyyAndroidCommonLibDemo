...
import com.hyy.android.common.crop.CropView;
import com.hyy.android.common.crop.FrameOverlayView;
...
//    private boolean isNativeEnable;
    ...
    private IDCameraInterface IDCameraInterface;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hyy_commlib_ocr_activity_camera);

        IDCameraInterface = IDCameraManager.getInstance(this).getmIDCameraInterface();
...
//    }
    ...
    private void updateFlashMode() {
        ...
        if (flashMode == ICameraControl.FLASH_MODE_TORCH) {
            lightButton.setImageResource(R.drawable.hyy_commlib_ocr_light_on);
        } else {
            lightButton.setImageResource(R.drawable.hyy_commlib_ocr_light_off);
        }
    }
                ...
                public void run() {
                    ...
                    if(null != IDCameraInterface){
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                IDCameraInterface.onResult(contentType);
                            }
                        });
                    }
        ...
        switch (requestCode) {
            case PERMISSIONS_REQUEST_CAMERA: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(getApplicationContext(), R.string.hyy_commlib_camera_permission_required, Toast.LENGTH_LONG)
                            .show();
                }
                break;
            }
