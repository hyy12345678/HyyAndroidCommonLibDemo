...
public class OCRCameraLayout extends FrameLayout {
    ...
    private void parseAttrs(AttributeSet attrs) {
        TypedArray a = getContext().getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.hyy_commlib_OCRCameraLayout,
                0, 0);
        try {
            contentViewId = a.getResourceId(R.styleable.hyy_commlib_OCRCameraLayout_hyy_commlib_contentView, -1);
            centerViewId = a.getResourceId(R.styleable.hyy_commlib_OCRCameraLayout_hyy_commlib_centerView, -1);
            leftDownViewId = a.getResourceId(R.styleable.hyy_commlib_OCRCameraLayout_hyy_commlib_leftDownView, -1);
            rightUpViewId = a.getResourceId(R.styleable.hyy_commlib_OCRCameraLayout_hyy_commlib_rightUpView, -1);
        } finally {
            a.recycle();
        }
    }
