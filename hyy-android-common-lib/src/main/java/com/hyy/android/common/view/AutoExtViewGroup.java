...
public class AutoExtViewGroup extends ViewGroup {
    ...
    private static String HYY_TAG = "AutoExtViewGroup";
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d(HYY_TAG, "widthMeasureSpec=" + widthMeasureSpec
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            Log.i(HYY_TAG, "i:" + i + ",wholeWidth:" + wholeWidth
                    + ",stageWidth:" + stageWidth + ",stageHeight:" + stageHeight + ",stage:" + stages);
        }

        Log.i(HYY_TAG, "stages:" + stages);
