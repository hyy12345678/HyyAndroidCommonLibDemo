...
import com.hyy.android.common.util.DimensionUtil;
import com.hyy.android.common.util.ImageUtil;
...
//    }
    ...
    public void setMaskType(@MaskView.MaskType int maskType, final Context ctx) {
        ...
        int hintResourceId = R.drawable.hyy_commlib_ocr_hint_align_id_card;
        this.maskType = maskType;
        boolean isNeedSetImage = true;
        switch (maskType) {
            case MaskView.MASK_TYPE_ID_CARD_FRONT:
                hintResourceId = R.drawable.hyy_commlib_ocr_round_corner;
            ...
            case MaskView.MASK_TYPE_BANK_CARD:
                hintResourceId = R.drawable.hyy_commlib_ocr_hint_align_bank_card;
                break;
...
//        }
        ...
        hintViewText.setBackgroundResource(R.drawable.hyy_commlib_ocr_round_corner);
